...
function admin_login(string $username, string $password): bool
{
    ...
    if (admin_is_employee_portal()) {
        $account = admin_find_employee_by_username($username);
        if (is_array($account)) {
            ...
            $expectedUsername = EMPLOYEE_ADMIN_USERNAME;
            $expectedPasswordHash = EMPLOYEE_ADMIN_PASSWORD_HASH;
            $displayName = 'Default Employee Admin';
        }
    }
