            ...
            <?php $megaStyleCol = ob_get_clean(); ob_start(); ?>
                <div class="mega-col mega-col-collections">
                  ...
                  <?php foreach ($navRingMetals as $navMetal): ?>
                    <a href="<?php e(resolve_link('/shop/?' . http_build_query($ringSectionQuery + ['color' => $navMetal['label']]))); ?>" class="mega-link-with-image">
                      <div class="img-wrap"><i class="fas fa-circle" style="font-size:1.1rem; color:<?= h($navMetal['hex']); ?>;"></i></div>
                      <span><?php e($navMetal['label']); ?></span>
                    </a>
                  <?php endforeach; ?>
