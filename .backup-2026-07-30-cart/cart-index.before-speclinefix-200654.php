...
<style>
  ...
  /* Specs — refined definition list, clean border grid */
  ...
  .cart-page .cart-line-spec:nth-child(2n) { border-right: 0; }
  /* Remove bottom border on items in the last visual row.
     Works for both even and odd child counts. */
  .cart-page .cart-line-spec:nth-last-child(1) { border-bottom: 0; }
  .cart-page .cart-line-spec:nth-last-child(2):nth-child(odd) { border-bottom: 0; }
  .cart-page .cart-line-spec.is-wide {
    grid-column: 1 / -1;
    border-right: 0;
  }
  ...
  .cart-page .cart-line-spec span {
    ...
    color: var(--cart-mute); margin: 0; font-weight: 600; line-height: 1;
  }
  ...
  @media (max-width: 900px) {
    ...
    .cart-page .cart-layout { grid-template-columns: 1fr; gap: 36px; }
  ...
  @media (max-width: 620px) {
    .cart-page .cart-line-specs { grid-template-columns: 1fr; }
    .cart-page .cart-line-spec { border-right: 0; }
    .cart-page .cart-line-spec.is-wide { padding-left: 0; padding-right: 0; }
