...
<?php
// ── "Choose your style" carousel (rings -> ring styles; others -> facet cards) ──
// "Choose your style" carousel: ring styles on ring pages only. Non-ring pages
// already carry their style/facet chips inside the (untouched) hero, so we do
