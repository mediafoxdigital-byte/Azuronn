          ...
          <?php if ($isRingMega): ?>
            ...
            <div class="mega-drop mega-drop-wide">
              <div class="mega-inner luxury-mega-menu" style="grid-template-columns: 1fr 1fr 1fr 1.4fr;">
                ...
                <div class="mega-col mega-col-gender">
                  <div class="mega-col-title">SHOP WEDDING RINGS</div>
                  <a href="<?php e(resolve_link('/shop/?' . http_build_query($ringSectionQuery + ['gender' => 'womens']))); ?>" class="mega-link-with-image">
                    <div class="img-wrap"><i class="fas fa-ring" style="font-size:1.35rem; color:#c9a96e;"></i></div>
                    <span>Women's Wedding Rings</span>
                  </a>
                  <a href="<?php e(resolve_link('/shop/?' . http_build_query($ringSectionQuery + ['gender' => 'mens']))); ?>" class="mega-link-with-image">
                    <div class="img-wrap"><i class="fas fa-ring" style="font-size:1.35rem; color:#c9a96e;"></i></div>
                    <span>Men's Wedding Rings</span>
                  </a>
                  <a href="<?php e(resolve_link('/shop/?' . http_build_query($ringSectionQuery))); ?>" class="mega-link-with-image">
                    <div class="img-wrap"><i class="far fa-gem" style="font-size:1.35rem; color:#c9a96e;"></i></div>
                    <span>All Wedding Rings</span>
                  </a>
                  <a href="<?php e(resolve_link('/shop/?type=Ring')); ?>" class="mega-show-all-btn">Show All Rings</a>
                </div>
                <?php else: ?>
                ...
                <div class="mega-col mega-col-collections">
                  ...
                  <?php foreach ($navRingMetalColors as $navMetalColor): ?>
                    <a href="<?php e(resolve_link('/shop/?' . http_build_query($ringSectionQuery + ['color' => $navMetalColor]))); ?>" class="mega-link-with-image">
                      <div class="img-wrap"><i class="fas fa-circle" style="font-size:1.1rem; color:#c9a96e;"></i></div>
                ...
                <div class="mega-col mega-col-feature-card">
                  <div class="feature-card-inner">
                    <div class="feature-img">
                      <img src="/assets/uploads/featured-diamond-ring.jpg" alt="<?= $navRingSection === 'wedding' ? 'Wedding Rings' : 'Diamond Rings' ?>">
                    </div>
                    <div class="feature-content">
                      <h3><?= $navRingSection === 'wedding' ? 'Wedding Rings' : 'Diamond Rings' ?></h3>
                      <p><?php e($item['feature']['subtitle'] ?? ($navRingSection === 'wedding' ? "Women's and men's wedding bands in gold and platinum, crafted to last a lifetime." : 'Discover ring styles, shapes, and custom design options in one beautiful collection.')); ?></p>
